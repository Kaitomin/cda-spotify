  ...
  return (
    <nav className='secondary-nav position-fixed bottom-0 w-100 border-top border-1 d-sm-none'>
      <ul className='d-flex justify-content-around m-0 list-unstyled'>
        ...
        <li><Link to="/search" className='text-light' aria-label='Search'><i className="fa-solid fa-magnifying-glass"></i></Link></li>
        { isAuthenticated && <li><Link to='/playlists' className='text-light' aria-label='Playlists'><i className="fa-solid fa-list"></i></Link></li>}
