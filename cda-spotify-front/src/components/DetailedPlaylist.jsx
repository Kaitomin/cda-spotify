    ...
    return (
        <div className="detailed-playlist">
            <div className='d-flex justify-content-center align-items-center column-gap-2'>
                ...
                {showActions && !isModalOpen && <i className="fa-solid fa-pen-to-square edit-btn" onClick={() => setIsModalOpen(true)}></i>}
            </div>
            {isModalOpen && (
            ...
            <div className="music-list d-flex flex-column align-items-start m-auto">
                ...
                {musicList && musicList.map((music, index) => (
                    <div key={music.id} className={`music-item track-${music.id} d-flex align-items-center justify-content-around w-100 p-2 ${musicIndex == index ? 'active' : ''}`}>
