          ...
          {musicList.map((music, index) => (
            <div key={music.id} className="music-item-search bg-white rounded">
              <Link to={`/music/${music.id}`} className="text-decoration-none text-black">            
                <img src={`${import.meta.env.VITE_RESOURCE_IMG_URL}/${music.imgUri}`} alt={music.title} loading={index > 6 ? 'lazy' : 'eager'} className="music-image-search rounded-top object-fit-cover" width={100 + '%'} height={150} />
